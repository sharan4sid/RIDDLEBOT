...
export default function GamePage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center w-full flex-grow pt-8 pb-12">
      <Card className="w-full max-w-2xl shadow-lg border-border transition-transform duration-200 ease-in-out hover:scale-[1.01] hover:shadow-xl">
